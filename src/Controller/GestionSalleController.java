...
public class GestionSalleController implements Initializable {
    ...
    void afficher(MouseEvent event) throws IOException {
        Parent root = null;
        try{
            root = FXMLLoader.load(getClass().getResource("/Views/AfficherSalles.fxml"));
        } catch (IOException e){
    ...
    private void ajouter(MouseEvent event) {
        Parent root = null;
        try{
            root = FXMLLoader.load(getClass().getResource("/Views/AjouterSalle.fxml"));
        } catch (IOException e){
    ...
    private void modifier(MouseEvent event) {
        Parent root = null;
        try{
            root = FXMLLoader.load(getClass().getResource("/Views/ModifierSalle.fxml"));
        } catch (IOException e){
    ...
    private void supprimer(MouseEvent event) {
        Parent root = null;
        try{
            root = FXMLLoader.load(getClass().getResource("/Views/SupprimerSalle.fxml"));
        } catch (IOException e){
