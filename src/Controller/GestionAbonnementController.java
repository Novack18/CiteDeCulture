...
public class GestionAbonnementController implements Initializable {
    ...
    void afficher(MouseEvent event) throws IOException {
        Parent root = null;
        try{
            root = FXMLLoader.load(getClass().getResource("/Views/AfficherAbonnements.fxml"));
        } catch (IOException e){
    ...
    private void ajouter(MouseEvent event) {
        Parent root = null;
        try{
            root = FXMLLoader.load(getClass().getResource("/Views/AjouterAbonnement.fxml"));
        } catch (IOException e){
    ...
    private void supprimer(MouseEvent event) {
        Parent root = null;
        try{
            root = FXMLLoader.load(getClass().getResource("/Views/SupprimerAbonnement.fxml"));
        } catch (IOException e){
